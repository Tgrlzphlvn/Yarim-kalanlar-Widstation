...
@Composable
fun CurrencyScreen(navController: NavController,  currencyViewModel: CurrencyViewModel = hiltViewModel()) {

    val items by currencyViewModel.currencyList.observeAsState()
